        ...
        $(window).scroll(function() {
            ...
            if (scrollPos > scrollBreakPoint) {
                $('#navb').addClass('nav-fade');
				        $('.navbar-brand').css({'max-width':'65px','padding':'0'});
                $('.navbar .navbar-brand img').attr('src','http://localhost:8888/redtower/img/round-logo.png');
            } else {
                $('#navb').removeClass('nav-fade');
				        $('.navbar-brand').css({'max-width':'175px','padding':'15px 0px 5px 15px'});
                $('.navbar .navbar-brand img').attr('src','http://localhost:8888/redtower/img/logo.png');
            }
        });
    });
